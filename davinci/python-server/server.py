...
# Add DaVinci Resolve script path
# The path varies by platform and Resolve version
# Users may need to adjust this
try:
    import DaVinciResolveScript as dvr_script
except ImportError:
    print("WARNING: DaVinciResolveScript not found in Python path")
    print("Please ensure DaVinci Resolve Studio is installed and the scripting module is available")
    dvr_script = None
...
if __name__ == '__main__':
    ...
    if init_resolve():
        ...
        print("  The server will still start, but Resolve features won't work until connected")
